...
"[project]/src/lib/admin-manager.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useAdmins() {
    ...
    const addAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAdmins.useCallback[addAdmin]": (newAdmin)=>{
            if (!newAdmin.email || !newAdmin.password) {
                throw new Error('Email and password are required.');
            }
            setAdmins({
                "useAdmins.useCallback[addAdmin]": (prevAdmins)=>{
                    if (prevAdmins.some({
                        "useAdmins.useCallback[addAdmin]": (admin)=>admin.email === newAdmin.email
                    }["useAdmins.useCallback[addAdmin]"]) || newAdmin.email === 'hsahilhuda@gmail.com') {
            ...
            }["useAdmins.useCallback[addAdmin]"]);
        }
    }["useAdmins.useCallback[addAdmin]"], []);
    const deleteAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAdmins.useCallback[deleteAdmin]": (emailToDelete)=>{
            setAdmins({
                "useAdmins.useCallback[deleteAdmin]": (prevAdmins)=>{
                    const updatedAdmins = prevAdmins.filter({
                        "useAdmins.useCallback[deleteAdmin].updatedAdmins": (admin)=>admin.email !== emailToDelete
                    }["useAdmins.useCallback[deleteAdmin].updatedAdmins"]);
                    saveAdmins(updatedAdmins);
                    return updatedAdmins;
                }
            }["useAdmins.useCallback[deleteAdmin]"]);
        }
    }["useAdmins.useCallback[deleteAdmin]"], []);
    return {
        admins,
...
_s(useAdmins, "/xrH5pW6TUfYqY6pWjDK3fIahrs=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/admin-manager.ts [app-client] (ecmascript)");
;
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            try {
                ...
                if (session) {
                    ...
                    const admins = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdmins"])();
                    if (email === ADMIN_EMAIL || admins.some({
                        "AuthProvider.useEffect": (admin)=>admin.email === email
                    }["AuthProvider.useEffect"])) {
                        setIsLoggedIn(true);
                        setUserEmail(email);
                    }
...
_s(AuthProvider, "jsgH7DagjTm2Bf4ptDF/rNcHMgo=", false, function() {
    return [
...
//# sourceMappingURL=src_02b915e3._.js.map